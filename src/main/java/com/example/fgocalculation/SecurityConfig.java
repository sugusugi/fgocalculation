...
import com.example.fgocalculation.filter.FormAuthenticationProvider;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    */
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        ("/terms", "/privacy", "/user/new", "/user", "/sessions/login", "/calculator/**", "/**/search", "/calculation/**").permitAll()
                ...
                // ログイン処理
                .and().formLogin().loginProcessingUrl("/login").loginPage("/").defaultSuccessUrl("/").failureUrl("/login-failure")
                .permitAll();
        // @formatter:on
    }
