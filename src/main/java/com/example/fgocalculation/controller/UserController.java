...
public class UserController {
    ...
    public String editName(@Validated @ModelAttribute("userNameForm") UserNameForm userNameForm,
    ...
    public String editEmail(@Validated @ModelAttribute("userEmailForm") UserEmailForm userEmailForm,
            BindingResult bindingResult, Principal principal, Model model) {
        ToolNameForm form = new ToolNameForm();
    ...
    public String editPassword(@Validated @ModelAttribute("userPasswordForm") UserPasswordForm userPasswordForm,
            BindingResult bindingResult, Principal principal, Model model) {
        ToolNameForm form = new ToolNameForm();
        Authentication authentication = (Authentication) principal;
        UserEntity user = repository.findByEmail(((UserEntity) authentication.getPrincipal()).getEmail());
